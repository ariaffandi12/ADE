...
# Menampilkan label "Matriks A"
print("\nMatriks A")  
# Membuat array 1 dimensi berisi elemen 1 sampai 4
Matriks1 = np.array([1, 2, 3, 4])  
# Menampilkan isi Matriks1
print(Matriks1)  

# Menampilkan label "Matriks B"
print("\nMatriks B")  
# Membuat array 2 dimensi (2 baris, 4 kolom) dengan isi yang sama
